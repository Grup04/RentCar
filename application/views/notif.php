    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
          <li class="active"><a href="<?=site_url('home_2')?>">Home</a></li>
        </ul>
      </div>
    </div>
  </div>
            ...
            <tbody>
              ...
              <tr>
               ...
               <?php if ($key->status == "Memesan") {?>
                  <a href="<?php echo site_url('home_2/pembayaran_detail/'.$key->id_order);?>"><button type="button" class="btn btn-success">Bayar</button></a>
