    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
          <li class="active"><a href="<?=site_url('home_3/pembayaran')?>">Home</a></li>
        </ul>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <div class="cform" id="contact-form">
            ...
            <div class="row">
            <form action="<?=site_url('home_3/pembayaran_doadd')?>" method="post" role="form" class="contactForm" enctype="multipart/form-data">
