...
<aside class="left-sidebar">
    <div class="scroll-sidebar">
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <li>
                    <a href="<?=site_url('home_3');?>" class="waves-effect"><i class="fa fa-home m-r-10" aria-hidden="true"></i>Home</a>
                </li>
                <!-- <li>
                                ...
                                <tbody>
                                    <?php foreach ($tampil_user as $key): ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="../admin/ubah_user2/<?=$key->user_id?>"><button type="button" class="btn btn-primary">Update</button></a>
